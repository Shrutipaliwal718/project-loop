...
const ThemesSection = ({ analytics }: ThemesSectionProps) => {
      ...
      <div className="h-full rounded-xl border border-cyan-400/[0.12] bg-[#061322]/90 p-4 sm:p-5">
        ...
        <div className="mt-5 space-y-3.5">
          {themes.length > 0 ? (
            ...
            <div className="rounded-lg border border-white/[0.06] bg-white/[0.02] px-3 py-5 text-center">
