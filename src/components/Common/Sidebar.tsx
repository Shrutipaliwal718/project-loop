...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed left-0 top-0 z-50 h-screen w-[250px] border-r border-white/[0.08] bg-[#030912]/95 backdrop-blur-xl transition-transform duration-300 ease-out lg:z-40 lg:block lg:translate-x-0 ${
          ...
          <div className="border-b border-white/[0.06] px-5 py-5">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="ml-auto flex h-8 w-8 items-center justify-center rounded-lg text-slate-500 transition hover:bg-white/[0.04] hover:text-slate-200 lg:hidden"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
